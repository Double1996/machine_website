class Admin::CoursesController < Admin::ApplicationController
  ...
  def show
    ...
    return redirect_to upload_admin_course_path(@course) if @course.status.in?(%w(new uploading))
  end
  ...
  def create
    ...
    respond_to do |format|
      if @course.save
        format.html {redirect_to upload_admin_course_path(@course), notice: '文件资料已经创建'}
  ...
  def update
    ...
    respond_to do |format|
      if @course.update(course_params)
        format.html {redirect_to @course, notice: '文件资料已经更新'}
